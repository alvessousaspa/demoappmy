...
class Config {
  ...
  /// Generated by SiteNative 17-08-2022 01:53:54
  ...
  static String color = "#10102D";
  // Active color (any HEX color)
  static String activeColor = "#10102D";
  // Icon color color (any HEX color)
  static String iconColor = "#10102D";
  ...
  static String indicatorColor = "#10102D";
  ...
  static String drawerBackgroundColor = "#10102D";
  // Title color (true - white, false - black)
  ...
  // Background color (any HEX color)
  static String splashBackgroundColor = "#101020";
  ...
  // Tagline
  static String splashTagline = "convert your website easy";
  ...
  static List<NavigationItem> mainNavigation = [
    	NavigationItem(name: "home",icon: "home.svg",type: ActionType.internal,value: "https://appmyweb.net",),
	NavigationItem(name: "Signin",icon: "log-in.svg",type: ActionType.internal,value: "https://my.appmyweb.net/#/account/apps",),
	NavigationItem(name: "register",icon: "person-add.svg",type: ActionType.internal,value: "https://my.appmyweb.net/#/account/apps",),
